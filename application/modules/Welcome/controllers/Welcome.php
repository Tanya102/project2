...
class Welcome extends MX_Controller {
	 ...
	 public function index() {
	     ...
	     $data['latest_articles'] = $this->View_Model->get_latest_article();
	     $data['promoted_articles'] = $this->View_Model->get_promoted_article();
         $data['pop_articles'] = $this->View_Model->get_popular_article();
